...
function create() {
    ...
    for (var i = 0; i < tilemapBodies.length; i++) {
        tilemapBodies[i].setCollisionCategory(1);
    }
    ...
    ship.body.setCollisionCategory(3);
    ship.life = 5;
    ...
    for (var i = 0; i < enemyPositions.length; i++) {
        ...
        enemy.body.setCollisionCategory(2);
    ...
    game.add.text(5, 5, 'Use WASD to move, mouse button to shoot.', { fill: '#ffffff', font: '14pt Arial' });
...
function updateCaptions() {
    ...
    caption1.x = game.camera.x + 5;
    caption2.x = game.camera.x + 5;
    caption3.x = game.camera.x + 5;
