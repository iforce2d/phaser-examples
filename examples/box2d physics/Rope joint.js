...
function create() {
	...
	// using the position of the sprites to determine the joint length.
	{
		...
		//bodyA, bodyB, length, ax, ay, bx, by
	...
	game.add.text(5, 5, 'Rope joint. Click to start.', { fill: '#ffffff', font: '14pt Arial' });
	game.add.text(5, 25, 'Mouse over bodyA to see the code used to create the joint.', { fill: '#ffffff', font: '14pt Arial' });
	codeCaption = game.add.text(5, 50, 'Parameters: bodyA, bodyB, length, ax, ay, bx, by', { fill: '#dddddd', font: '10pt Arial' });
